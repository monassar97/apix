    ...
    //read all parents
     public function readParent(){
        ...
        public function deleteAdmin(){
            // create query
            $query='DELETE FROM school.admin WHERE id=:id';
        ...
        public function deleteClass(){
            // create query
            $query='DELETE FROM school.class WHERE id=:id';
        ...
        public function deleteNotification(){
            // create query
            $query='DELETE FROM school.notification WHERE id=:id';
        ...
        public function deleteParent(){
            // create query
            $query='DELETE FROM school.parents WHERE id=:id';
        ...
        public function deleteSchool(){
            // create query
            $query='DELETE FROM school.schools WHERE id=:id';
        ...
        public function deleteStudent(){
            // create query
            $query='DELETE FROM school.students WHERE id=:id';
        ...
        public function deleteTeacher(){
            // create query
            $query='DELETE FROM school.teacher WHERE id=:id';
